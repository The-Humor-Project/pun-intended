export default function AssignmentWeek6Page() {
  return (
    <main className="page">
              ...
              <div className="week__section-header">
                ...
                <div className="week__meeting">
                  ...
                  <span className="week__meeting-value">
                    Friday, February 27th, 2026 at 4pm ET
                  </span>
                </div>
              </div>
              <ul>
                <li>Create admin-only routes and lock down access.</li>
                <li>List and filter captions, images, and users.</li>
