export type WeekItem = string | { label: string; href: string };
...
export const weeks: Week[] = [
  {
    ...
    meetingAgendaItems: [
      "Create a new flavor using The Matrix",
      "Download IntelliJ",
    ...
    assignmentItems: [
      ...
      "Complete all humorstudy.org ratings for the week.",
    ],
  },
  {
  ...
  },
  {
    ...
    assignmentItems: ["Complete all humorstudy.org ratings for the week."],
  },
  {
